...
/**
 * Returns an object containing the geolocation information for the given IP address.
 * @function ipLoc
 * @param {string} IP - The IP address to geolocate.
 * @returns {Object} An object containing the IP address, country code, and city name.
 */
